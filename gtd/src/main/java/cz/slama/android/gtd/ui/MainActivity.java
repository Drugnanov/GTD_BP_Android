...
import cz.slama.android.gtd.events.NavItemSelectedEvent;
import cz.slama.android.gtd.utils.util.Ln;
import cz.slama.android.gtd.utils.util.SafeAsyncTask;
import cz.slama.android.gtd.utils.util.UIUtils;
 ...
 * {@link cz.slama.android.gtd.authenticator.ApiKeyProvider#getAuthKey(android.app.Activity)}
 */
public class MainActivity extends BootstrapFragmentActivity {
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    //String certifikate = getCertificateSHA1Fingerprint();
    mainActivity = this;
    ...
    if (!isTablet()) {
      ...
      drawerToggle = new ActionBarDrawerToggle(
          ...
          R.string.navigation_drawer_open,    /* "open drawer" descriptionText */
          R.string.navigation_drawer_close) { /* "close drawer" descriptionText */
