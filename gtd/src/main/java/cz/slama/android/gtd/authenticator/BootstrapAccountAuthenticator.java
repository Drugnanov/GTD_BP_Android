...
import static cz.slama.android.gtd.authenticator.BootstrapAuthenticatorActivity.PARAM_AUTHTOKEN_TYPE;

class BootstrapAccountAuthenticator extends AbstractAccountAuthenticator {

    private static final String DESCRIPTION_CLIENT = "GTD for Android";
     ...
     * {@link cz.slama.android.gtd.authenticator.ApiKeyProvider#getAuthKey()}
