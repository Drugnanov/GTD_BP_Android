...
[![Build Status](https://travis-ci.org/AndroidBootstrap/cz-slama-android-gtd.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/cz-slama-android-gtd)

This repository contains the source code for the [gtd](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=cz.slama.android.gtd).

Please see the [issues](https://github.cz.slama.android.gtd/cz-slama-android-gtd/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about gtd? Ask away on the [cz-slama-android-gtd discussion forum](https://groups.google.com/forum/#!forum/cz-slama-android-gtd).

<a href="https://play.google.com/store/apps/details?id=cz.slama.android.gtd" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __cz.slama.android.gtd__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____cz.slama.android.gtd__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.cz.slama.android.gtd.R__) will now be renamed
...
signed with a different key.  Manually uninstall gtd from your device and
...
gtd is a result of a template project I've developed over the years as well as
...
## Contributors
Thank you to all the [contributors](http://www.github.cz.slama.android.gtd/cz-slama-android-gtd/contributors) on
...
[pull requests](https://github.cz.slama.android.gtd/cz-slama-android-gtd/pulls).
