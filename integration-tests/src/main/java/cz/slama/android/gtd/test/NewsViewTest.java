...
package cz.slama.android.gtd.test;

import static cz.slama.android.gtd.core.Constants.Extra.NEWS_ITEM;
import android.content.Intent;
import android.test.ActivityInstrumentationTestCase2;

import cz.slama.android.gtd.core.News;
import cz.slama.android.gtd.ui.CarouselActivity;
...
public class NewsViewTest extends ActivityInstrumentationTestCase2<CarouselActivity> {
    ...
    /**
     * Create test for {@link cz.slama.android.gtd.ui.CarouselActivity}
     */
    public NewsViewTest() {
